...
user_parser.add_argument("user_name", type=str, default="default", help="User name is required.", location=["form", "args"])
user_parser.add_argument("user_email", required=True, type=str, help="User email is required.", location=["form", "args"])
user_parser.add_argument("user_pass", required=True, type=str, help="User password is required.", location=["form", "args"])

media_parser = reqparse.RequestParser()
media_parser.add_argument("user_email", required=True, type=str, help="User email is required.", location=["form", "args"])
media_parser.add_argument("u_token", required=True, type=str, help="User token is required.", location=["form", "args"])
media_parser.add_argument("m_token", type=str, default="default", help="Media token is required.", location=["form", "args"])
media_parser.add_argument("music_author", required=False, type=str, default="default", help="Author name is required.", location=["form", "args"])
media_parser.add_argument("music_name", required=False, type=str, default="default", help="Media name is required.", location=["form", "args"])
media_parser.add_argument("music_is_public", required=False, type=bool, default=True, help="Set the content's privacy policy.", location=["form", "args"])
