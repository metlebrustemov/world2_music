...
media_parser.add_argument("music_author", required=False, type=str, help="Author name is required.")
media_parser.add_argument("music_name", required=False, type=str, help="Media name is required.")
media_parser.add_argument("music_is_public", required=False, type=str, help="Set the content's privacy policy.")
